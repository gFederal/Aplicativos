...
namespace FedAllChampionsUtility
{
	class Thresh : Champion
	{
		...
		private void EngageFriendLatern()
		{
            ...
            foreach (var friend in Program.Helper.OwnTeam.Where(hero => !hero.IsMe && hero.Distance(ObjectManager.Player) <= W.Range + 300 && hero.Distance(ObjectManager.Player) <= W.Range - 300 && hero.Health / hero.MaxHealth * 100 >= 25 && Utility.CountEnemysInRange(150) >= 1))
			{
                    ...
                    Program.Helper.OwnTeam
						.Where(
							hero =>
                                ...
                                hero.Distance(ObjectManager.Player) <= W.Range - 200 && hero.Health / hero.MaxHealth * 100 >= 25 && !hero.IsDead))
			{

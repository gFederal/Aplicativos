...
namespace FedAllChampionsUtility
{
    class Vi : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            /* [ Don't Use Ult ] */
            Program.Menu.SubMenu("Combo").AddSubMenu(new Menu("Don't use Ult on", "DontUlt"));
            ...
            Program.Menu.SubMenu("Combo").AddSubMenu(new Menu("Focus in TF", "FindHim"));
            Program.Menu.SubMenu("Combo").SubMenu("FindHim")
            ...
            Program.Menu.SubMenu("Combo").AddSubMenu(comboUseQ);
            ...
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("UseFQCombo", "Use Flash+Q").SetValue(true));
            Program.Menu.SubMenu("Combo")
                .AddItem(
            ...
            Program.Menu.SubMenu("Harass").AddSubMenu(harassUseQ);
            ...
            Program.Menu.SubMenu("Harass").AddItem(new MenuItem("HarassMana", "Min. Mana Percent: ").SetValue(new Slider(50, 100, 0)));
            ...
            Program.Menu.SubMenu("LaneClear").AddItem(new MenuItem("UseQLaneClear", "Use Q").SetValue(false));
            Program.Menu.SubMenu("LaneClear").AddItem(new MenuItem("UseELaneClear", "Use E").SetValue(false));
            Program.Menu.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearMana", "Min. Mana Percent: ").SetValue(new Slider(50, 100, 0)));
            ...
            Program.Menu.SubMenu("JungleFarm").AddItem(new MenuItem("UseQJungleFarm", "Use Q").SetValue(true));
            Program.Menu.SubMenu("JungleFarm").AddItem(new MenuItem("UseEJungleFarm", "Use E").SetValue(false));
            ...
            Program.Menu.SubMenu("JungleFarm").AddItem(new MenuItem("JungleFarmMana", "Min. Mana Percent: ").SetValue(new Slider(50, 100, 0)));
            ...
            Program.Menu.AddSubMenu(MenuExtras);
            ...
            Program.Menu.SubMenu("Extras").AddSubMenu(menuUseItems);
            ...
            Program.Menu.SubMenu("Drawings").AddItem(new MenuItem("QRange", "Q Range").SetValue(new Circle(true,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Program.Menu.SubMenu("Drawings").AddItem(new MenuItem("ERange", "E Range").SetValue(new Circle(false,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Program.Menu.SubMenu("Drawings").AddItem(new MenuItem("RRange", "R Range").SetValue(new Circle(false,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Program.Menu.SubMenu("Drawings").AddItem(new MenuItem("SmiteRange", "Smite Range").SetValue(new Circle(false,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Program.Menu.SubMenu("Drawings").AddItem(new MenuItem("FQRange", "Flash+Q Range").SetValue(new Circle(false,
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            var drawFqCombo = Program.Menu.Item("FQRange").GetValue<Circle>();
            if (drawFqCombo.Active)
            {
                Utility.DrawCircle(vPlayer.Position, Q.Range + FlashRange, drawFqCombo.Color);
            }

            var drawSmite = Program.Menu.Item("SmiteRange").GetValue<Circle>();
            if (Program.Menu.Item("AutoSmite").GetValue<KeyBind>().Active && drawSmite.Active)
            {
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            if (Program.Menu.Item("ComboFlashQActive").GetValue<KeyBind>().Active)
            {
                ComboFlashQ();
            }
            ...
            {
                var existsMana = vPlayer.MaxMana / 100 * Program.Menu.Item("HarassMana").GetValue<Slider>().Value;
            ...
            {
                var existsMana = vPlayer.MaxMana / 100 * Program.Menu.Item("LaneClearMana").GetValue<Slider>().Value;
                if (vPlayer.Mana >= existsMana)
                    LaneClear();
            }
            ...
            {
                var existsMana = vPlayer.MaxMana / 100 * Program.Menu.Item("JungleFarmMana").GetValue<Slider>().Value;
                if (vPlayer.Mana >= existsMana)
                    JungleFarm();
            }
        }
        ...
        private static void Combo()
        {
            ...
            var useQDontUnderTurret = Program.Menu.Item("UseQComboDontUnderTurret").GetValue<bool>();
        ...
        {
            var useFq = Program.Menu.Item("UseFQCombo").GetValue<bool>();
            if (!useFq) return;
        ...
        private static void Harass()
        {
            ...
            var useQ = Program.Menu.Item("UseQHarass").GetValue<bool>();
            var useE = Program.Menu.Item("UseEHarass").GetValue<bool>();

            var useQDontUnderTurret = Program.Menu.Item("UseQHarassDontUnderTurret").GetValue<bool>();
            if (qTarget != null && Q.IsReady() && useQ)
            {
                if (useQDontUnderTurret)
                {
        ...
        {
            if (!Program.Menu.Item("JungleFarmActive").GetValue<KeyBind>().Active) return;

            var useQ = Program.Menu.Item("UseQJungleFarm").GetValue<bool>();
            var useE = Program.Menu.Item("UseEJungleFarm").GetValue<bool>();
        ...
        {
            if (!Program.Menu.Item("LaneClearActive").GetValue<KeyBind>().Active) return;

            var useQ = Program.Menu.Item("UseQLaneClear").GetValue<bool>();
            var useE = Program.Menu.Item("UseELaneClear").GetValue<bool>();
        ...
        {
            var interruptSpells = Program.Menu.Item("InterruptSpells").GetValue<KeyBind>().Active;
        ...
        private static void UseSummoners()
        {
            if (SmiteSlot == SpellSlot.Unknown)
                return;
            if (!Program.Menu.Item("AutoSmite").GetValue<KeyBind>().Active) return;

...
using FedAllChampionsUtility.Annotations;
using SharpDX;
...
namespace FedAllChampionsUtility
{
    ...
    class BaseUlt
    {
        ...
        public BaseUlt()
        {
            ...
            _menu.AddItem(new MenuItem("panicKey", "Panic key").SetValue(new KeyBind(32, KeyBindType.Press))); //32 == space
            _menu.AddItem(new MenuItem("regardlessKey", "No timelimit").SetValue(new KeyBind(17, KeyBindType.Press))); //17 == ctrl
